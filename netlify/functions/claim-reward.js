...
exports.handler = async (event) => {
  try {
    ...
    if (!user) return { statusCode: 404, body: JSON.stringify({ ok: false, message: 'User not found' }) };
    ...
    return { statusCode: 200, body: JSON.stringify({ ok: true, coins: newCoins, reward: 100 }) };
  } catch (e) {
